...
<body> 
    ...
    <br><br><br><br><br>
    <div class="content">
        <div class="moduleTitle scale-up-top">Lección 1.3: La vía y sus partes</div><br>
        <div class="video-container scale-up-bottom">
            <div id="central-video-title" class="video-title">Video 1.3: La via y sus partes</div>
            <video id="central-video" controls poster="../imagenes/miniaturas/1.3 La via y sus partes.jpg">
                <source id="central-video-source" src="../Videos/1.3 La via y sus partes.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion1-3.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego3.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>

    <?php 
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='La via y sus partes' AND tipo='quiz' AND desbloqueado = 0 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
...
<script>
    ...
    video.addEventListener('timeupdate', function() {
      ...
      <?php  
             if($fila == 0){ 
                 $sql = "INSERT INTO juegos (nombre, tipo, desbloqueado, puntaje, lecciones_id, lecciones_modulos_id) VALUES ('La via y sus partes','quiz',0,0,$id_lecciones ,$id_modulos);";
                 $res = $con->query($sql);
             }
      ?>
