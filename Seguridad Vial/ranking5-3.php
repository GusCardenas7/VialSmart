...
<body> 
    ...
    <div class="ranking-container content">
        <h2 class="ranking-title">Mejores puntuaciones - Juego 5.3: Prevención y seguridad en caso de desastres</h2>
    ...
    <script>
        ...
        fetch(`../Admin/funciones/obtenerPuntuaciones.php?nombre_juego='Prevencion y seguridad en caso de desastres
'`)
