...
<body> 
    ...
    <div class="content">
        <div class="header-container">
                    ...
                    <div class="moduleTitle scale-up-top">Lección 1.2: Los usuarios de la vía</div>
                </div>
                <div id="lessons" class="lessons scale-up-bottom">
                    <p>En la vía pública, hay varios tipos de personas que la usan cada día para desplazarse. A estas personas se les llama usuarios de la vía. Es importante conocer quiénes son para entender cómo debemos comportarnos, ya sea caminando, en bicicleta o en automóvil.</p> <br><br>
                    <p style="font-weight:bold; color:#618c49;">🚶‍♀️ Peatones 🚶‍♂️</p>
                    <p>Los peatones son todas las personas que caminan por las calles y aceras. Cuando somos peatones, es muy importante prestar atención a lo que sucede a nuestro alrededor. Debemos cruzar por los lugares adecuados, como los pasos de cebra, y esperar el semáforo en verde para los peatones antes de cruzar. Además, debemos evitar usar el teléfono o audífonos mientras caminamos, para no distraernos.</p> <br><br>
                    <p style="font-weight:bold; color:#b7a900;">🚴🏼‍♀️ Ciclistas 🚴🏼‍♂️</p>
                    <p>Los ciclistas son las personas que se desplazan usando bicicletas. Ellos deben usar los carriles bici si los hay, o mantenerse cerca de la orilla de la calzada. Además, es muy importante que los ciclistas lleven equipo de seguridad como cascos, luces y reflectores, especialmente por la noche. Los ciclistas también deben seguir las reglas de tránsito, como respetar los semáforos y ceder el paso a los peatones cuando sea necesario.</p> <br><br>
                    <p style="font-weight:bold; color:#0b8398;">🚗Conductores 🚗</p>
                    <p>Los conductores son quienes manejan autos, motocicletas u otros vehículos en la calle. Tienen la responsabilidad de estar siempre atentos, conducir a una velocidad adecuada y respetar todas las señales de tránsito. Los conductores deben ceder el paso a peatones y ciclistas, y asegurarse de que su vehículo esté en buenas condiciones para evitar accidentes.</p><br><br>
                    <p style="font-weight:bold; color:#C70039;">🚍 Pasajeros 🚖</p>
...
function desbloquear(){
   ...
   <?php if($fila == 0){ ?>
          ...
          xhr.send("id_lecciones=" + <?php echo $id_lecciones; ?> + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Los usuarios de la via'");
