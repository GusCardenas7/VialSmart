    ...
    <div class="content">
        ...
        <div class="video-container scale-up-bottom">
            ...
            <video id="central-video" controls poster="../imagenes/miniaturas/8.2 Resolucion de conflictos en la via.jpg">
                <source id="central-video-source" src="../Videos/8.2 Resolucion de conflictos en la via.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion8-2.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego22.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>
    ...
    // Verificamos si el vídeo ha llegado a los 30 segundos
      ...
      <?php if($fila == 0){ ?>
           ...
           xhr.send(
            ...
            "&nombre_leccion=Resolucion de conflictos en la via"
           );
         <?php } ?>
