...
<body> 
    ...
    <br><br><br><br><br>
    <div class="content">
        <div class="moduleTitle scale-up-top">Lección 6.3: Seguridad personal</div><br>
        <div class="video-container scale-up-bottom">
            <div id="central-video-title" class="video-title">Video 6.3: Seguridad personal</div>
            <video id="central-video" controls poster="../imagenes/miniaturas/6.3 Seguridad personal.jpg">
                <source id="central-video-source" src="../Videos/6.3 Seguridad personal.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion6-3.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego18.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>
    ...
    // Verificamos si el vídeo ha llegado a los 30 segundos
      ...
      <?php if($fila == 0){ ?>
           ...
           xhr.send(
            ...
            "&nombre_leccion=Seguridad personal"
           );
         <?php } ?>
