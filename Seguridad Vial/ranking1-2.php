...
<body> 
    ...
    <div class="ranking-container content">
        <h2 class="ranking-title">Mejores puntuaciones - Juego 1.2: Los usuarios de la vía</h2>
    ...
    <script>
        ...
        fetch(`../Admin/funciones/obtenerPuntuaciones.php?nombre_juego='Los usuarios de la via'`)
