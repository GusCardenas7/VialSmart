...
<body> 
    ...
    <div class="content">
        ...
        <div class="arrowsContainer">
            <div><a href="leccion4-2.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego11.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>

    <?php 
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='Comportamiento seguro en el automovil' AND tipo='adivinanza' AND desbloqueado = 0 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
...
<script>
    ...
    // Verificamos si el vídeo ha llegado a los 30 segundos
      ...
      <?php  
             if($fila == 0){ 
                 $sql = "INSERT INTO juegos (nombre, tipo, desbloqueado, puntaje, lecciones_id, lecciones_modulos_id) VALUES ('Comportamiento seguro en el automovil','adivinanza',0,0,$id_lecciones ,$id_modulos);";
                 $res = $con->query($sql);
             }
      ?>   
