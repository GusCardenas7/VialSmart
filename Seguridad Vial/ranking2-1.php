...
<body> 
    ...
    <div class="ranking-container content">
        <h2 class="ranking-title">Mejores puntuaciones - Juego 2.1: Tipos de señales de tránsito</h2>
    ...
    <script>
        ...
        fetch(`../Admin/funciones/obtenerPuntuaciones.php?nombre_juego='Tipos de señales de transito'`)
