...
<head>
    ...
    <title> Memorama Lección 5.2 </title>
...
<body>
    ...
    <?php 
       ...
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='Primeros auxilios basicos' AND tipo='memorama'  AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
        ...
        if($fila == 0){
        $sql = "INSERT INTO juegos (nombre, tipo, desbloqueado, puntaje, lecciones_id, lecciones_modulos_id) VALUES ('Primeros auxilios basicos','memorama',0,0,$id_lecciones ,$id_modulos);";
        $res = $con->query($sql);
        }
    ...
    <!-- Juego -->
    <h1 style="color:#000000;">🚑 Primeros auxilios básicos 🚑</h1>
...
function bloquearTarjetas() {
    for (let i = 0; i <= 15; i++) {
        ...
        tarjetaBloqueada.innerHTML = `<img src="../imagenes/Puzzle/Leccion14/${numeros[i]}.png" alt="">`;
...
function destapar(id) {
    ...
    if (tarjetasDestapadas == 1) {
        ...
        Tarjeta1.innerHTML = `<img src="../imagenes/Puzzle/Leccion14/${primerResultado}.png" alt="">`;
        ClickAudio.play();
        ...
        Tarjeta2.innerHTML = `<img src="../imagenes/Puzzle/Leccion14/${segundoResultado}.png" alt="">`;
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Primeros auxilios viales'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos);
                  } else {
