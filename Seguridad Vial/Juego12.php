...
function revisarpuntaje(){
    if(aciertos >= 6){
         ...
         if (xhr.readyState === 4) {
             if (xhr.status === 200) {
                ...
                var xhr2 = new XMLHttpRequest();
                        ...
                        if (xhr2.readyState === 4) {
                            if (xhr2.status === 200) {
                              ...
                              if(puntos === 100) {
                                ...
                                xhr3.send("nombre='Viajero escolar responsable'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos); 
                            }
                            } else {
                    ...
                    xhr2.send("nombre='Maestro de la seguridad en el vehículo'&id_usuario=" + <?php echo $id_usuario; ?>);
             } else {
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Que hacer en caso de accidente'" + "&nombre_modulo='Situaciones de emergencia'" + "&id_usuario=" + <?php echo $id_usuario; ?>+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
