...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        if(TotalAciertos>=4){
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Guardián de las señales de tránsito'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntaje);
                  } else {
            ...
            xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntaje + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Señales de transito mas comunes'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?> );
