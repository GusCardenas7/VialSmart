...
function revisarpuntaje(){
    if(aciertos >= 6){
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje=40" + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Uso del cinturon de seguridad'" + "&nombre_modulo='Seguridad en el vehiculo'" + "&id_usuario=" + <?php echo $id_usuario; ?>);
