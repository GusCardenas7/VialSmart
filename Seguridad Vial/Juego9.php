...
function revisarpuntaje(){
    if(aciertos >= 6){
         ...
         if (xhr.readyState === 4) {
             if (xhr.status === 200) {
                ...
                var xhr2 = new XMLHttpRequest();
                        ...
                        if (xhr2.readyState === 4) {
                            if (xhr2.status === 200) {
                              ...
                              if(puntos === 100) {
                                ...
                                xhr3.send("nombre='Ciclista seguro'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos); 
                            }
                            } else {
                    ...
                    xhr2.send("nombre='Reglas básicas aprendidas'&id_usuario=" + <?php echo $id_usuario; ?>);
             } else {
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Uso del cinturon de seguridad'" + "&nombre_modulo='Seguridad en el vehiculo'" + "&id_usuario=" + <?php echo $id_usuario; ?>);
