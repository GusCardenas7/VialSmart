...
function revisarpuntaje(){
    if(aciertos >= 4){
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Respeto mutuo'" + "&nombre_modulo='Convivencia vial y cultura de la paz'" + "&id_usuario=" + <?php echo $id_usuario; ?>+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
