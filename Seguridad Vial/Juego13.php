...
function seleccionar(casilla) {
    ...
    if (num_click == 1) {
        ...
        if (fin == true) {
            ...
            xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Primeros auxilios basicos'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
