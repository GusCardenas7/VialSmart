...
<head>
    <meta charset="utf-8" />
    <title>Puzzle Lecci&#243;n 5.1</title>
...
<body>
 ...
 <!-- MENU -->
    <?php 
       ...
       $sql = "SELECT * FROM modulos WHERE nombre='Situaciones de emergencia' AND usuarios_id = $id_usuario"; //aqu� var�a el nombre del m�dulo
       $res = $con->query($sql);
       ...
       $sql = "SELECT * FROM lecciones WHERE nombre='Que hacer en caso de accidente' AND desbloqueado = 1 AND modulos_id = $id_modulos"; //aqu� var�a el nombre del m�dulo
       $res = $con->query($sql);
       ...
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='Que hacer en caso de accidente' AND tipo='Puzzle'  AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
        ...
        if($fila == 0){
        $sql = "INSERT INTO juegos (nombre, tipo, desbloqueado, puntaje, lecciones_id, lecciones_modulos_id) VALUES ('Que hacer en caso de accidente','Puzzle',0,0,$id_lecciones ,$id_modulos);";
        $res = $con->query($sql);
        }
...
<table>
   <tr>
       <td><img id="0" src="../imagenes/memoramas/Leccion5/0.jpg" onclick="seleccionar(0)"></td>
       <td><img id="1" src="../imagenes/memoramas/Leccion5/1.jpg" onclick="seleccionar(1)"></td>
       <td><img id="2" src="../imagenes/memoramas/Leccion5/2.jpg" onclick="seleccionar(2)"></td>
       <td><img id="3" src="../imagenes/memoramas/Leccion5/3.jpg" onclick="seleccionar(3)"></td>
       <td><img id="4" src="../imagenes/memoramas/Leccion5/4.jpg" onclick="seleccionar(4)"></td>
   </tr
   <tr>
       <td><img id="5" src="../imagenes/memoramas/Leccion5/5.jpg" onclick="seleccionar(5)"></td>
       <td><img id="6" src="../imagenes/memoramas/Leccion5/6.jpg" onclick="seleccionar(6)"></td>
       <td><img id="7" src="../imagenes/memoramas/Leccion5/7.jpg" onclick="seleccionar(7)"></td>
       <td><img id="8" src="../imagenes/memoramas/Leccion5/8.jpg" onclick="seleccionar(8)"></td>
       <td><img id="9" src="../imagenes/memoramas/Leccion5/9.jpg" onclick="seleccionar(9)"></td>
   </tr>
   <tr>
       <td><img id="10" src="../imagenes/memoramas/Leccion5/10.jpg" onclick="seleccionar(10)"></td>
       <td><img id="11" src="../imagenes/memoramas/Leccion5/11.jpg" onclick="seleccionar(11)"></td>
       <td><img id="12" src="../imagenes/memoramas/Leccion5/12.jpg" onclick="seleccionar(12)"></td>
       <td><img id="13" src="../imagenes/memoramas/Leccion5/13.jpg" onclick="seleccionar(13)"></td>
       <td><img id="14" src="../imagenes/memoramas/Leccion5/14.jpg" onclick="seleccionar(14)"></td>
   </tr>
   <tr>
       <td><img id="15" src="../imagenes/memoramas/Leccion5/15.jpg" onclick="seleccionar(15)"></td>
       <td><img id="16" src="../imagenes/memoramas/Leccion5/16.jpg" onclick="seleccionar(16)"></td>
       <td><img id="17" src="../imagenes/memoramas/Leccion5/17.jpg" onclick="seleccionar(17)"></td>
       <td><img id="18" src="../imagenes/memoramas/Leccion5/18.jpg" onclick="seleccionar(18)"></td>
       <td><img id="19" src="../imagenes/memoramas/Leccion5/19.jpg" onclick="seleccionar(19)"></td>
   </tr>
   <tr>
       <td><img id="20" src="../imagenes/memoramas/Leccion5/20.jpg" onclick="seleccionar(20)"></td>
       <td><img id="21" src="../imagenes/memoramas/Leccion5/21.jpg" onclick="seleccionar(21)"></td>
       <td><img id="22" src="../imagenes/memoramas/Leccion5/22.jpg" onclick="seleccionar(22)"></td>
       <td><img id="23" src="../imagenes/memoramas/Leccion5/23.jpg" onclick="seleccionar(23)"></td>
       <td><img id="24" src="../imagenes/memoramas/Leccion5/24.jpg" onclick="seleccionar(24)"></td>
   </tr
</table>
</section>
<!--Como Jugar-->
...
<!-- Imagen Correcta -->
 <div class="imagen_correcta">
   ...
   <div> <img class="fondo" src="../imagenes/memoramas/Leccion5/SV_memorama.jfif" alt="" > </div>
 </div>
</div>
<!-- Tiempo -->
...
<footer>
   ...
   <!-- <script type="text/javascript" src="../JS/Juego13.js"></script> -->
    ...
    if (num_click == 1) {
        ...
        if (fin == true) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Reacción ante accidentes'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos);
                  } else {
            ...
            Swal.fire({
                ...
                confirmButtonText: '<a class="quitar" href="leccion5-2.php">Siguiente</a>'
            })
            //-------
