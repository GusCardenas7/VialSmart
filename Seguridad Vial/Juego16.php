  ...
  if(isCorrectMatching) {
    ...
    //alert("¡Felicidades! Has ganado el juego.");
       ...
       //---BD----
            ...
            xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntaje + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Estrategias de prevencion'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
