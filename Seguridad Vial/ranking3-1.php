...
<body> 
    ...
    <div class="ranking-container content">
        <h2 class="ranking-title">Mejores puntuaciones - Juego 3.1: Cruce seguro de la calle</h2>
    ...
    <script>
        ...
        fetch(`../Admin/funciones/obtenerPuntuaciones.php?nombre_juego='Cruce seguro en las calles'`)
