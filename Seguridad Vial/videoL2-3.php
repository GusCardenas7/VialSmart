...
<body> 
    ...
    <br><br><br><br><br>
    <div class="content">
        <div class="moduleTitle scale-up-top">Lección 2.3: Señales especiales para niños</div><br>
        <div class="video-container scale-up-bottom">
            <div id="central-video-title" class="video-title">Video 2.3: Señales especiales para niños</div>
            <video id="central-video" controls poster="../imagenes/miniaturas/2.3 Señales especiales para niños.jpg">
                <source id="central-video-source" src="../Videos/2.3 Señales especiales para niños.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion2-3.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego6.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>
    ...
    // Verificamos si el vídeo ha llegado a los 30 segundos
        if (tiempoActual >= 140 && !bandera) {
           ...
           xhr.send(
            ...
            "&nombre_leccion=Señales especiales para niños"
           );
         <?php } ?>
