...
<head>
    ...
    <title> Memorama Lección 3.2 </title>
...
<body>
    ...
    <!-- Juego -->
    <h1 style="color:#000000;">🚶‍ Comportamiento peatonal seguro 🚶‍</h1>
...
function bloquearTarjetas() {
    for (let i = 0; i <= 15; i++) {
        ...
        tarjetaBloqueada.innerHTML = `<img src="../imagenes/Puzzle/Leccion8/${numeros[i]}.png" alt="">`;
...
function destapar(id) {
    ...
    if (tarjetasDestapadas == 1) {
        ...
        Tarjeta1.innerHTML = `<img src="../imagenes/Puzzle/Leccion8/${primerResultado}.png" alt="">`;
        ClickAudio.play();
        ...
        Tarjeta2.innerHTML = `<img src="../imagenes/Puzzle/Leccion8/${segundoResultado}.png" alt="">`;
        ...
        if (primerResultado == segundoResultado) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Peatón responsable'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos);
                  } else {
            ...
            xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Uso seguro de la bicicleta'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
