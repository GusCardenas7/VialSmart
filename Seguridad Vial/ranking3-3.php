...
<body> 
    ...
    <div class="ranking-container content">
        <h2 class="ranking-title">Mejores puntuaciones - Juego 3.3: Uso seguro de la bicicleta</h2>
    ...
    <script>
        ...
        fetch(`../Admin/funciones/obtenerPuntuaciones.php?nombre_juego='Uso seguro de la bicicleta'`)
