...
<body> 
    ...
    <div class="content">
        <div class="header-container">
                    ...
                    <div class="moduleTitle scale-up-top">Lección 5.2: Primeros auxilios básicos</div>
                </div>
                <div id="lessons" class="lessons scale-up-bottom">
                    <p style="color:#295854">Cuando ocurre un accidente en la calle, es importante saber cómo reaccionar de manera segura y ayudar a otros si es posible. Aquí aprenderás algunos primeros auxilios básicos que pueden salvar vidas.</p> <br><br>
                    <p style="font-weight:bold; color:#a20909;">🚑 Manten la calma </p><br><p>Recordemos que lo primero que debes hacer es mantener la calma. Esto te ayudará a pensar con claridad y tomar buenas decisiones. </p><br><br>
                    <p style="font-weight:bold; color:#a20909;">🚑 Pide ayuda</p><br><p>Como se indico en la lección anterior siempre que ocurra un accidente, lo más importante es llamar a los servicios de emergencia marcando 911. Diles exactamente lo que ha sucedido y dónde te encuentras. Mientras esperas a que lleguen, sigue estos pasos básicos.</p><br><br>
                    <p style="font-weight:bold; color:#a20909;">🚑 Detener el sangrado </p><br><p style="color:#4d4443; font-style: italic;">Si alguien tiene una herida que está sangrando mucho:</p>
                    <p>     1. Usa un paño limpio o alguna prenda de ropa para presionar sobre la herida y detener el sangrado.</p><p>     2. No uses nada sucio y evita tocar la herida con las manos si no tienes algo limpio para cubrirla.</p><br><br>
                    <p style="font-weight:bold; color:#a20909;">🚑 Qué hacer si alguien está inconsciente </p><br><p style="color:#4d4443; font-style: italic;">Si una persona está inconsciente pero respira, lo mejor que puedes hacer es:</p>
...
function desbloquear(){
   ...
   <?php if($fila == 0){ ?>
          ...
          xhr.send("id_lecciones=" + <?php echo $id_lecciones; ?> + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Primeros auxilios basicos'");
