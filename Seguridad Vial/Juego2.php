    ...
    if (tarjetasDestapadas == 1) {
        ...
        if (primerResultado == segundoResultado) {
            ...
            if (aciertos == 8) {
              ...
              xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Identificación de usuarios viales'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos); 
                  } else {
              ...
              xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='La via y sus partes'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
