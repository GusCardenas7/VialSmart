...
<body> 
    ...
    <br><br><br><br><br>
    <div class="content">
        <div class="moduleTitle scale-up-top">Lección 7.2: Interacción con extraños</div><br>
        <div class="video-container scale-up-bottom">
            <div id="central-video-title" class="video-title">Video 7.2: Interacción con extraños</div>
            <video id="central-video" controls poster="../imagenes/miniaturas/7.2 Interaccion con extraños.jpg">
                <source id="central-video-source" src="../Videos/7.2 Interaccion con extraños.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion7-2.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego20.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>

    <?php 
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='Interaccion con extraños' AND tipo='quiz' AND desbloqueado = 0 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
