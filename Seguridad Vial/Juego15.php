...
function revisarpuntaje(){
    if(aciertos >= 6){
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje=40" + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Identificacion de situaciones de riesgo'" + "&nombre_modulo='Seguridad vial y prevencion de delitos'" + "&id_usuario=" + <?php echo $id_usuario; ?>);
