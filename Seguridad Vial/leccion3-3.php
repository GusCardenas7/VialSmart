...
<body> 
    ...
    <div class="content">
        <div class="header-container">
                    ...
                    <div class="moduleTitle scale-up-top">Lección 3.3: Uso seguro de la bicicleta</div>
                </div>
                <div id="lessons" class="lessons scale-up-bottom">
                    <p style="color:#4d4443">Andar en bicicleta es una actividad divertida y saludable, pero también es muy importante hacerlo de manera segura. Aquí te compartimos algunos consejos para que disfrutes de tu paseo sin correr riesgos.</p> <br><br>
                    <p style="font-weight:bold; color:#5ca545;">🚲 Usa siempre el casco: </p><p>El casco es la parte más importante de tu equipo de seguridad cuando andas en bicicleta. Un casco bien ajustado puede protegerte en caso de una caída. Asegúrate de que te quede bien y que esté abrochado.</p><br>
                    <p style="font-weight:bold; color:#5ca545;">🚲 Luces y reflectores: </p><p>Si vas a andar en bicicleta cuando hay poca luz o de noche, es fundamental que tu bicicleta tenga luces delanteras y traseras, así como reflectores en las ruedas y los pedales. Estos elementos ayudan a que los conductores y otros peatones te vean mejor.</p><br>
                    <p style="font-weight:bold; color:#5ca545;">🚲 Reglas básicas de tránsito: </p><p>Cuando andas en bicicleta, debes seguir las mismas reglas de tránsito que los autos. </p><br>
                    <p style="font-weight:bold; color:#5ca545;">🚲 Mantente alerta: </p><p>Siempre debes estar atento a tu entorno. Mira hacia adelante y a los lados para evitar obstáculos o posibles peligros. No uses el teléfono mientras andas en bicicleta, ya que te distrae y puede hacer que pierdas el control.</p><br>
                    <p style="font-weight:bold; color:#5ca545;">🚲 Revisar la bicicleta: </p><p>Antes de salir, asegúrate de que tu bicicleta esté en buenas condiciones. Revisa los frenos, las llantas y el manubrio para asegurarte de que todo funcione correctamente.</p><br>
                    <br><p style="color:#4d4443;  font-style: italic;"><i>Siguiendo estos consejos, estarás listo para disfrutar de tu paseo en bicicleta de forma segura. ¡Recuerda que la seguridad es lo primero!</i></p>
                </div>
                <center> <button class="btn" id="boton" onclick="desbloquear()"> Marcar como completo </button> </center> <!-- Añadí esto-->
                
        <div class="arrowsContainer">
            <div><a href="Juego8.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="videoL3-3.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div> 
    <?php    
        // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM videos WHERE nombre='Uso seguro de la bicicleta' AND desbloqueado = 1 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
...
<?php 
    ...
    if($fila == 0){ 
       $sql = "INSERT INTO videos (nombre, desbloqueado, lecciones_id, lecciones_modulos_id) VALUES ('Uso seguro de la bicicleta',1,$id_lecciones ,$id_modulos);";
       $res = $con->query($sql);
      }
?>
