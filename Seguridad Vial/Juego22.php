         ...
         if (xhr.readyState === 4) {
             if (xhr.status === 200) {
              ...
              var xhr2 = new XMLHttpRequest();
                    ...
                    if (xhr2.readyState === 4) {
                        if (xhr2.status === 200) {
                            ...
                            if(puntos >= 99) {
                                ...
                                xhr3.send("nombre='Resolución pacífica de conflictos'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos2); 
                            }
                        } else {
                ...
                xhr2.send("nombre='Graduado en seguridad vial'&id_usuario=" + <?php echo $id_usuario; ?>); 
             } else {
