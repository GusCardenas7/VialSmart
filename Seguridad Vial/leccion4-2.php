...
<body> 
    <?php 
       ...
       $sql = "SELECT * FROM lecciones WHERE nombre='Comportamiento seguro en el automovil' AND desbloqueado = 1 AND modulos_id = $id_modulos"; //aquí varía el nombre del módulo
       $res = $con->query($sql);
    ...
    <div class="content">
        <div class="header-container">
                    ...
                    <div class="moduleTitle scale-up-top">Lección 4.2: Comportamiento seguro en el automóvil</div>
                </div>
                <div id="lessons" class="lessons scale-up-bottom">
                    <p style="color:#4d4443">Viajar en automóvil puede ser divertido, pero también es importante seguir ciertas reglas para mantenernos seguros y no distraer al conductor. Aquí te contamos algunas recomendaciones para tener un comportamiento seguro dentro del coche.</p> <br><br>
                    <p style="font-weight:bold; color:#5ca545;">🚙 Evita distracciones al conductor </p><p>El conductor necesita estar siempre concentrado en el camino. Por eso, es importante que no lo distraigas:</p><br>
                    <p>     1. Evita gritar o hacer ruido innecesario.</p><p>     2. No le muestres cosas o le pidas que te preste atención mientras maneja.</p><p>     3. Mantén la calma, sobre todo si el tráfico está complicado.</p><br><br>
                    <p style="font-weight:bold; color:#5ca545;">🚙 Mantente sentado y abrochado</p><p>Una de las reglas más importantes es permanecer sentado y con el cinturón de seguridad bien puesto durante todo el viaje. No importa si es un trayecto corto, siempre debes ir sentado en tu lugar y no moverte por el coche mientras está en movimiento.</p><br><br>
                    <p style="font-weight:bold; color:#5ca545;">🚙 Cómo entrar y salir del coche de manera segura </p> <p>Al subir o bajar del automóvil:</p><br>
                    <p>     1. Espera a que el coche esté completamente detenido antes de abrir la puerta.</p><p>     2. Siempre que sea posible, baja del coche por el lado de la banqueta, lejos del tráfico.</p><p>     3. Asegúrate de que no venga otro vehículo antes de salir.</p><br><br>
                    <p style="font-weight:bold; color:#5ca545;">🚙  No asomes partes del cuerpo por la ventana </p> <p>Aunque puede ser tentador, nunca debes sacar las manos, cabeza o cualquier parte del cuerpo por la ventana mientras el coche está en movimiento. Esto puede ser muy peligroso.</p><br><br>
                </div>
                <center> <button class="btn" id="boton" onclick="desbloquear()"> Marcar como completo </button> </center> <!-- Añadí esto-->
                
        <div class="arrowsContainer">
            <div><a href="Juego10.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="videoL4-2.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div> 

    <?php    
        // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM videos WHERE nombre='Comportamiento seguro en el automovil' AND desbloqueado = 1 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
...
<?php 
    ...
    if($fila == 0){ 
       $sql = "INSERT INTO videos (nombre, desbloqueado, lecciones_id, lecciones_modulos_id) VALUES ('Comportamiento seguro en el automovil',1,$id_lecciones ,$id_modulos);";
       $res = $con->query($sql);
      }
?>
