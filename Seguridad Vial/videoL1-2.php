...
<body> 
    ...
    <br><br><br><br><br>
    <div class="content">
        <div class="moduleTitle scale-up-top">Lección 1.2: Usuarios de la vía</div><br>
        <div class="video-container scale-up-bottom">
            <div id="central-video-title" class="video-title">Video 1.2: Usuarios de la via</div>
            <video id="central-video" controls poster="../imagenes/miniaturas/1.2 Usuarios de la via.jpg">
                <source id="central-video-source" src="../Videos/1.2 Usuarios de la via.mp4" type="video/mp4">
                Tu navegador no soporta la reproducción de videos.
            </video>
        </div>
        <div class="arrowsContainer">
            <div><a href="leccion1-2.php"><img src="../imagenes/regresar.png" width="90px" height="90px"></a></div>
            <div id="FlechaDesbloqueada"><a href="Juego2.php"><img src="../imagenes/avanzar.png" width="90px" height="90px"></a></div>
        </div>
    </div>

     <?php 
       // Verifico si existe ya un registro con esos datos
        $sql = "SELECT * FROM juegos WHERE nombre='Los usuarios de la via' AND tipo='memorama' AND desbloqueado = 0 AND lecciones_id = $id_lecciones AND lecciones_modulos_id = $id_modulos";
        $res = $con->query($sql);
