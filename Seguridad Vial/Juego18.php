...
function revisarpuntaje(){
    if(aciertos >= 6){
       ...
       xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntos + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Respuestas en casos de emergencia'" + "&nombre_modulo='Disuacion de delitos'" + "&id_usuario=" + <?php echo $id_usuario; ?>+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
