         ...
         if (xhr.readyState === 4) {
             if (xhr.status === 200) {
                ...
                var xhr2 = new XMLHttpRequest();
                        ...
                        if (xhr2.readyState === 4) {
                            if (xhr2.status === 200) {
                              ...
                              if(puntos === 100) {
                                ...
                                xhr3.send("nombre='Educador vial infantil'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntos); 
                            }
                            } else {
                    ...
                    xhr2.send("nombre='Experto en señales de tránsito'&id_usuario=" + <?php echo $id_usuario; ?>);
             } else {
