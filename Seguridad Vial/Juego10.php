...
const brands = [
  {
    imagePath: "../imagenes/Union/Leccion10/UsarCinturon.png", 
    signalName: "Usar el cinturón de seguridad"
  },
  {
    imagePath: "../imagenes/Union/Leccion10/TelaBien.png", 
    signalName: "Banda de tela no dañada"
  },
  {
    imagePath: "../imagenes/Union/Leccion10/SuperiorHombro.png", 
    signalName: "Cinta superior pasando por el hombro"
  },
  {
    imagePath: "../imagenes/Union/Leccion10/SinDobleces.png", 
    signalName: "Debe abrocharse sin dobleces"
  },
  {
    imagePath: "../imagenes/Union/Leccion10/AsientosInfantes.png", 
    signalName: "Asiento de seguridad para niños"
  },
  {
    imagePath: "../imagenes/Union/Leccion10/embarazo.png", 
    signalName: "Las mujeres embarazadas deben usar cinturón"
  }
];
    ...
    //alert("¡Felicidades! Has ganado el juego.");
       winAudio.play();
         ...
         //---BD----
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                  if (xhr.status === 200) {
                    ...
                    xhr2.send("nombre='Cinturón de seguridad al 100%'&id_usuario=" + <?php echo $id_usuario; ?> + "&puntos=" + puntaje);
                  } else {
            ...
            xhr.send("id_juego=" + <?php echo $id_juego; ?> + "&puntaje="+puntaje + "&id_modulos=" + <?php echo $id_modulos; ?> + "&nombre_leccion='Comportamiento seguro en el automovil'"+ "&puntajeInicial=" + <?php echo $puntajeInicial; ?>);
